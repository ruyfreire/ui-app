...
import r$2, { useRef, useContext, useMemo, useDebugValue, createElement } from 'react';
...
var Icon = styled.i(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (_a) {
    var pos = _a.pos;
    return Ae(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n    padding: 2px;\n    margin: ", ";\n  "], ["\n    padding: 2px;\n    margin: ", ";\n  "])), pos === 'right' ? '0 0 0 8px' : '0 8px 0 0');
});
...
var ThemeProviderUiApp = function (_a) {
    ...
    return (jsxs(Le, __assign({ theme: applyTheme }, { children: [jsx(GlobalStyle, {}), children] })));
};
