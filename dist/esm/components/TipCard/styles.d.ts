...
export declare const Wrapper: import("styled-components").StyledComponent<"div", DefaultTheme, import("react").HTMLAttributes<HTMLDivElement> & import("../../utils/styles").MarginTypes & {
